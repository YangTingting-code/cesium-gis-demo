<!-- 控制弹窗的长相 -->
<template>
  <div v-if="showRef.value" :id="id" class="divlabel-container">
    <div class="animate-maker-border">
      ...
      <div class="clear">
        <button @click="clearCircle">删除搜索圈</button>
      </div>
    </div>
  </div>
</template>
...
// //默认宽高
const { showRef, title: propTitle, id: propId ,chartData,removeCircle} = defineProps<Props>()
